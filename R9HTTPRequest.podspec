...
Pod::Spec.new do |s|
  ...
  s.description  = "HTTP client"

  s.homepage     = "https://github.com/glassonion1/R9HTTPRequest"
  ...
  s.source       = { :git => "https://github.com/glassonion1/R9HTTPRequest.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "R9HTTPRequest/**/*.{h,m,swift}"
